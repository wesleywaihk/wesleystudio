...
function bmMenu(){
	$('body').prepend('<div id="msgBox" class="lightBox">'+
									 '<div class="postAdjust" id="bmMenuBostAdjust" style="width:275px; height:142px;">'+
										 '<div class="contentBox" id="bmMenuContentBox" style="width:510px; height:245px; padding:20px; font-size:11px">'+
										 '<h4 style="margin:0px 0px 10px 0px; padding:0px">edit net status</h4>'+
										 '<div>'+
											 '<div style="width:90px; float:left">bet status</div>'+
											 '<div style="width:420px; float:left">'+
												 '<label style="line-height:16px; margin:0px; padding:0px; cursor:pointer"><div style="margin-bottom:10px"><input name="status" id="failed" type="radio" value="failed" style="margin:2px 0px 0px 0px; padding:0px" /> Failed</div></label>'+
												 '<label style="line-height:16px; margin:0px; padding:0px; cursor:pointer"><div style="margin-bottom:10px"><input name="status" id="Confirmed" type="radio" value="Confirmed" style="margin:2px 0px 0px 0px; padding:0px" /> Confirmed</div></label>'+	
												 '<label style="line-height:16px; margin:0px; padding:0px; cursor:pointer"><div style="margin-bottom:10px"><input name="status" id="Pending" type="radio" value="Pending" style="margin:2px 0px 0px 0px; padding:0px" /> Pending</div></label>'+	
												 '<label style="line-height:16px; margin:0px; padding:0px; cursor:pointer"><div style="margin-bottom:10px"><input name="status" id="Cancelled" type="radio" value="Cancelled/Rejected" style="margin:2px 0px 0px 0px; padding:0px" /> Cancelled/Rejected</div></label>'+	
												 '<label style="line-height:16px; margin:0px; padding:0px; cursor:pointer"><div style="margin-bottom:10px"><input name="status" id="Unknown" type="radio" value="Unknown" style="margin:2px 0px 0px 0px; padding:0px" /> Unknown</div></label>'+											 
											 '</div>'+
											 '<div style="width:90px; float:left; line-height:25px">bookie bet id</div>'+
											 '<div style="width:420px; float:left"><input name="" type="text" style="background:#f0efef; 	border:#333333 1px solid; -webkit-border-radius: 2px; -moz-border-radiust: 2px; border-radius: 2px"/></div>'+
										 '</div>'+
									 ...
									 //'</div>'+
									 //'</div>'+
									 '<div id="btnGroup" style="padding-bottom:10px;"><input name="closeBTN" id="closeBTN" type="button" value="ok" class="BTN" /></div>'+
									 '</div></div></div>');	
