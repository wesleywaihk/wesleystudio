...
/*if(! /Android|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) || screen.width>=760 ) {
	...
	if(/Android|webOS|iPhone|iPod|iPad|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
		window.open('http://www.samvogroup.com/en/main.html'+hashVar,'_top');
	}else{
		window.open('http://www.samvogroup.com/en/'+hashVar,'_top');
	}
}*/
currCell=1;
pageW=640;
...
function resize(){
	...
	if(pageH<865){
		...
		$('#mainMenu > ul > li:not(:last-child)').css('padding-top','18px').css('padding-bottom','6px');
		$('#mainMenu > ul > li:last-child').css('margin-top','25px');
		
		$('#home').css('background-position','73px 24px');
		$('#home > ul').css('top',225);
		$('#home > ul > li:not(:last-child)').css('padding-top','14px').css('padding-bottom','6px').css('margin-bottom','8px');
		...
		$('#mainMenu > ul > li:not(:last-child)').css('padding-top','22px').css('padding-bottom','10px');
		$('#mainMenu > ul > li:last-child').css('margin-top','40px');
		
		$('#home').css('background-position','73px 39px');
		$('#home > ul').css('top',283);
		$('#home > ul > li:not(:last-child)').css('padding-top','18px').css('padding-bottom','10px').css('margin-bottom','12px');
