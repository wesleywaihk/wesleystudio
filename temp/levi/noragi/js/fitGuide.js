...
$(function(){
  ...
  //
  $('#fitGuide #imgArea').append('<div class="imgUnit" id="img1"><image src="images/fitGuide/1.jpg"/></div>');
  ...
  setTimeout(function(){loadGuideIMG()}, 2000);
});
...
function loadGuideIMG(){
  for(a=2;a<=pageNum;a++){
	$('#fitGuide #imgArea #img'+a).append('<image src="images/fitGuide/'+a+'.jpg"/>')
  }
}